<footer class="bg-gray-800 text-gray-300 border-t border-gray-700">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <!-- Logo / Marque -->
            <div>
                <a href="{{ route('admin.dashboard') }}" class="text-2xl font-bold text-brand-red hover:text-brand-redDark transition">
                    GenShop
                </a>
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2 text-sm">
                    ...
                    <li><a href="{{ route('admin.products.index') }}" class="hover:text-white transition">Produits</a></li>
                    <li><a href="{{ route('admin.categories.index') }}" class="hover:text-white transition">Catégories</a></li>
                    <li><a href="{{ route('admin.orders.index') }}" class="hover:text-white transition">Commandes</a></li>
                    <li><a href="{{ route('admin.clients.index') }}" class="hover:text-white transition">Clients</a></li>
                </ul>
            </div>
        ...
        <div class="border-t border-gray-700 mt-8 pt-6 text-center text-sm text-gray-400">
            &copy; {{ date('Y') }} GenShop Admin. Tous droits réservés.
        </div>
    </div>
</footer>