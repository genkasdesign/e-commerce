    ...
    <div class="card p-8">
        ...
        <form method="POST" action="<?php echo e(route('password.email')); ?>">
            ...
            <p class="text-center text-gray-400 text-sm mt-4">
                <a href="<?php echo e(route('login')); ?>" class="text-brand-red hover:underline">Retour à la connexion</a>
            </p>
        </form>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\site-eCommerce\ecommerce\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>