        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('dashboard')); ?>" class="logo text-2xl font-bold hover:opacity-80 transition">
                        GenShop
                    </a>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-8 ml-10">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(auth()->user()->isAdmin()): ?>
                            ...
                            <a href="<?php echo e(route('admin.clients.index')); ?>" 
                               class="nav-link <?php echo e(request()->routeIs('admin.clients.*') ? 'active' : ''); ?>">
                                Clients
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('cart.index')); ?>" 
                               class="nav-link <?php echo e(request()->routeIs('cart.index') ? 'active' : ''); ?>">
                                Panier
                                <?php
                            ...
                            <a href="<?php echo e(route('wishlist.index')); ?>" 
                               class="nav-link <?php echo e(request()->routeIs('wishlist.index') ? 'active' : ''); ?>">
                                Favoris
                            </a>
                        <?php endif; ?>
                    <?php endif; ?>
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(!auth()->user()->isAdmin()): ?>
                            ...
                            <a href="<?php echo e(route('about')); ?>" class="nav-link <?php echo e(request()->routeIs('about') ? 'active' : ''); ?>">À propos</a>
                        <?php endif; ?>
                    <?php else: ?>
                        <a href="<?php echo e(route('contact')); ?>" class="nav-link <?php echo e(request()->routeIs('contact') ? 'active' : ''); ?>">Contact</a>
                        <a href="<?php echo e(route('faq')); ?>" class="nav-link <?php echo e(request()->routeIs('faq') ? 'active' : ''); ?>">FAQ</a>
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                    ...
                    <div x-show="dropdownOpen" 
                        ...
                        <a href="<?php echo e(route('profile.edit')); ?>" @click="dropdownOpen = false" 
                           class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition">
                           Profil
                        </a>
                        <form method="POST" action="<?php echo e(route('logout')); ?>" @click="dropdownOpen = false">
                            <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="btn-primary text-sm">Register</a>
                <?php endif; ?>
...
</script><?php /**PATH C:\xampp\htdocs\site-eCommerce\ecommerce\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>