<footer class="bg-gray-800 text-gray-300 border-t border-gray-700">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                <a href="<?php echo e(route('dashboard')); ?>" class="text-2xl font-bold text-brand-red hover:text-brand-redDark transition">
                    GenShop
                </a>
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2 text-sm">
                    <li><a href="<?php echo e(route('dashboard')); ?>" class="hover:text-white transition">Accueil</a></li>
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(!auth()->user()->isAdmin()): ?>
                            <li><a href="<?php echo e(route('cart.index')); ?>" class="hover:text-white transition">Panier</a></li>
                            <li><a href="<?php echo e(route('orders.index')); ?>" class="hover:text-white transition">Mes commandes</a></li>
                        <?php endif; ?>
                    <?php endif; ?>
                    ...
                    <li><a href="<?php echo e(route('about')); ?>" class="hover:text-white transition">À propos</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2 text-sm">
                    ...
                    <li><a href="<?php echo e(route('privacy')); ?>" class="hover:text-white transition">Politique de confidentialité</a></li>
        ...
        <div class="border-t border-gray-700 mt-8 pt-6 text-center text-sm text-gray-400">
            &copy; <?php echo e(date('Y')); ?> GenShop. Tous droits réservés.
        </div>
    </div>
</footer><?php /**PATH C:\xampp\htdocs\site-eCommerce\ecommerce\resources\views/layouts/footer.blade.php ENDPATH**/ ?>